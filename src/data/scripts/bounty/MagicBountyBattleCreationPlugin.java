...
//        String script = "data.scripts.bounty.MagicBountyBattleCreationPlugin"; //MagicBountyCoordinator.getInstance().getActiveBounty(bountyKey).getCustomEveryFrameCombatPluginClass();
//
