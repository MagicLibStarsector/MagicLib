...
public class MagicVariables {
    ...
    public static void checkBountySystems() {
        ...
        if (Global.getSettings().getModManager().isModEnabled("swp") && SWPModPlugin.Module_FamousBounties) {
        ...
        if (Global.getSettings().getModManager().isModEnabled("vayrasector") && VayraModPlugin.UNIQUE_BOUNTIES) {
