...
fun createMagicPaintjobRefitPanel(): CustomPanelAPI {
    class MagicPaintjobRefitPanelPlugin : BaseCustomUIPanelPlugin(){
        ...
        override fun renderBelow(alphaMult: Float) {
            ...
            GL11.glColor4f(panelColor.red / 255f, panelColor.green / 255f, panelColor.blue / 255f,
            ...
            GL11.glColor4f(bgColor.red / 255f, bgColor.green / 255f, bgColor.blue / 255f,
